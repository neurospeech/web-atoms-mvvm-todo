...
(function (factory) {
    ...
    var NewTaskWindow_commandTemplate_2 = /** @class */ (function (_super) {
        ...
        NewTaskWindow_commandTemplate_2.prototype.create = function () {
            ...
            this.append(e2);
            this.setLocalValue(e2, "atom-event-click", function () {
                return (this.getValue("viewModel")).save();
            });
            var e4 = document.createTextNode("\r\n        ");
            this.append(e4);
            var e5 = document.createElement("button");
            this.append(e5);
            this.setLocalValue(e5, "atom-event-click", function () {
                return (this.getValue("viewModel")).cancel();
            });

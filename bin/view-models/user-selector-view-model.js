            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, TaskListService.instance.getUsers(null)];
                        case 1:
                            _a.items = _b.sent();
                            return [2 /*return*/];
                    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, TaskListService.instance.getUsers(this.searchText)];
                        case 1:
                            _a.items = _b.sent();
                            return [2 /*return*/];
                    }
...
//# sourceMappingURL=user-selector-view-model.js.map